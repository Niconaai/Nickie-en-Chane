                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                                            {displayedDrinks.map((drink) => (
                                                ...
                                                <button
                                                    ...
                                                    className={`rounded-lg border text-left transition-colors flex items-center p-2 space-x-3 ${guest.drinkPreferences.includes(drink.id)
                                                    ...
                                                    {drink.imageUrl && (
                                                        <div className="flex-shrink-0 w-12 h-12 relative">
                                                            <Image
                                                                ...
                                                                sizes="48px"
                                                                unoptimized={true} // <--- Skips Vercel optimization entirely
                                                            />
                                                        </div>
                                                    )}
                                                    {/* Text container */}
