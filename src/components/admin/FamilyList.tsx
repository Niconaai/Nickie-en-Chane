        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex p-1 space-x-1 bg-gray-100 rounded-lg overflow-x-auto">
              ...
              <button
                onClick={() => setActiveFilter('not-attending')}
                className={`px-4 py-2 text-sm font-medium rounded-md transition-colors whitespace-nowrap ${
          ...
          <div className="mt-2 text-sm text-gray-500">
            Wys {filteredFamilies.length} van {families.length} gesinne
          </div>
        </div>
        ...
        <div className="divide-y divide-gray-200">
          {filteredFamilies.length === 0 ? (
             <div className="p-12 text-center text-gray-500">
               Geen gesinne gevind in hierdie kategorie nie.
             </div>
          ) : (
                            ...
                            {family.deposit_option && (
                              <div className="text-sm font-medium text-gray-700">
                                ...
                                <span className="text-gray-900">
                                  {family.deposit_option === 'gift' ? 'Geskenk 🎁' : 'Terugbetaling'}
                                </span>
                              </div>
                            )}
                          </div>
